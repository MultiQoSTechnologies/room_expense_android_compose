...
import com.example.expensemanagementsystem.screens.home.HomeViewModel
                ...
                Box(
                    ...
                    Row(
                        ...
                        GradientButtonWithIcon1(
                            ...
                            validationForAddExpenses(viewModel) {
                                onAccept()
                            }
                        }
                    }
...
fun validationForAddExpenses(viewModel: HomeViewModel, onSuccess: () -> Unit) {
